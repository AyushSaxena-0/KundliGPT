    ...
    <div className="flex-1 flex items-center justify-center bg-background px-4 py-16 relative overflow-hidden select-none">
      ...
      <Card className="w-full max-w-md glass-panel border-border/80 relative z-10">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription>Login to consult your personal birth chart history and profile details.</CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label htmlFor="password" className="block text-xs font-semibold uppercase tracking-wider text-mutedText">
                  Password
                </label>
